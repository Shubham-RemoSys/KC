...
WebUI.click(findTestObject('Object Repository/ShoppingCartObjects/a_1'))
...
WebUI.click(findTestObject('Object Repository/ShoppingCartObjects/a_Rings'))

WebUI.click(findTestObject('Object Repository/ShoppingCartObjects/a_2'))

WebUI.click(findTestObject('Object Repository/ShoppingCartObjects/a_'))

WebUI.click(findTestObject('Object Repository/ShoppingCartObjects/input_Are you sure want to delete this item_bf276f'))

WebUI.verifyElementText(findTestObject('Object Repository/ShoppingCartObjects/div_Item removed successfully'), 'Item removed successfully')
