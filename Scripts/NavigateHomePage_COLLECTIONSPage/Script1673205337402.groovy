...
WebUI.click(findTestObject('Object Repository/NavigateHomePage/a_Collections'))



WebUI.verifyElementText(findTestObject('Object Repository/NavigateHomePage/h1_Collections'), 'COLLECTIONS')
