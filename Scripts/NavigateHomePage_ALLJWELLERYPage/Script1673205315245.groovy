...
WebUI.click(findTestObject('Object Repository/NavigateHomePage/a_All Jewellery'))



WebUI.verifyElementText(findTestObject('Object Repository/NavigateHomePage/h1_All Jewellery'), 'ALL JEWELLERY')
