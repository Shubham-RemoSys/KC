...
WebUI.click(findTestObject('Object Repository/NavigateHomePage/a_Gold Chains'))

WebUI.verifyElementText(findTestObject('Object Repository/NavigateHomePage/h1_Gold Chains'), 'GOLD CHAINS')
