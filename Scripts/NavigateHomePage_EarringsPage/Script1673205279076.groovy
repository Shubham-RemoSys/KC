...
WebUI.click(findTestObject('Object Repository/NavigateHomePage/a_Earrings'))



WebUI.verifyElementText(findTestObject('Object Repository/NavigateHomePage/h1_View All Earrings'), 'VIEW ALL EARRINGS')
