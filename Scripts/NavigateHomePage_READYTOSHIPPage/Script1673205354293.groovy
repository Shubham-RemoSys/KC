...
WebUI.click(findTestObject('Object Repository/NavigateHomePage/a_ReadyToShip'))

WebUI.verifyElementText(findTestObject('Object Repository/NavigateHomePage/title_ReadyToShip'), 'READY TO SHIP')
