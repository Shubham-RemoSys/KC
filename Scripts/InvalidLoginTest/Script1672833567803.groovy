...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Gold  Diamond  Online Jewellery Shoppi_0b87d1/loginText'), 
    'Login')
...
WebUI.waitForElementVisible(findTestObject('LoginWindow/div_Invalid UsernamePassword'), 
    0)

WebUI.verifyElementText(findTestObject('LoginWindow/div_Invalid UsernamePassword'), 
