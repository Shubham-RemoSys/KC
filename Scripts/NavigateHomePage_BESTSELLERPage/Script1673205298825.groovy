...
WebUI.click(findTestObject('Object Repository/NavigateHomePage/a_Best Sellers'))


WebUI.verifyElementText(findTestObject('Object Repository/NavigateHomePage/h1_Best Sellers'), 'BEST SELLERS')
